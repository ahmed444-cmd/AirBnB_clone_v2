...
env.user = 'ubuntu'
env.hosts = ["54.173.159.6", "35.175.130.53"]
env.key_filename = "~/id_rsa"


def do_pack():
    """distributes the archive to your web servers
    """
...
def do_deploy(archive_path):
    """distributes the archive to our web servers
    """
