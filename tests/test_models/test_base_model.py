...
class TestBasemodel(unittest.TestCase):
    """Represents the tests for BaseModel."""
    ...
    def setUp(self):
        """Doing some operations before the tests are run."""
        pass

    def tearDown(self):
        """Doing some operations after the tests are run"""
        try:
            os.remove('file.json')
        except Exception:
            pass
    ...
    def test_init(self):
        """Tests the initialization of model class.
        """
    ...
    def test_save(self):
        """Tests  save function of  BaseModel class."""
        i = self.value()
        i.save()
        key = self.name + "." + i.id
    ...
    def test_kwargs_one(self):
        """Tests kwargs with 1 key-value pair."""
        n = {'Name': 'test'}
        new = self.value(**n)
