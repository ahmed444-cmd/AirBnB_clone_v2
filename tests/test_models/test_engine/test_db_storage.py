...
class TestDBStorage(unittest.TestCase):
    """ Class to test db storage method """
    def test_new(self):
        """ New object is added to database """
        new = User(
            email='kim2024@gmail.com',
            password='password',
            first_name='kim',
            last_name='friks'
        )
        ...
        self.assertIn('kim2024@gmail.com', result)
        self.assertIn('password', result)
        self.assertIn('kim', result)
        self.assertIn('friks', result)
        cursor.close()
        dbc.close()
